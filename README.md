...
| **4 · Footage** | generative clips | **motion graphics + CC stills + type on screen.** Graphics are the always-available fallback: if no clip fits a beat, the beat *becomes* a graphic |

A video built from **text, graphics and Creative-Commons stills** is a complete, legitimate output — not a downgrade. Explainers have been made that way for decades, and it's often *clearer* than stock footage that only vaguely matches what you're saying. `hyv-assembler` treats a graphic beat exactly like any other clip on the timeline.
...
| **4 · หาภาพ** | คลิป generative | **motion graphic + ภาพนิ่ง CC + ตัวหนังสือบนจอ** กราฟิกคือทางออกที่มีเสมอ: ถ้าไม่มีคลิปไหนเข้ากับบีตนั้น **ก็ทำบีตนั้นเป็นกราฟิกซะ** |

วิดีโอที่สร้างจาก **ตัวหนังสือ กราฟิก และภาพนิ่ง Creative-Commons คือผลงานที่สมบูรณ์ ไม่ใช่ของตกเกรด** — คลิปอธิบายความทำแบบนี้กันมาหลายสิบปีแล้ว และหลายครั้ง**ชัดกว่า**ฟุตเทจสต็อกที่เข้ากับสิ่งที่พูดแบบเลือน ๆ ด้วยซ้ำ `hyv-assembler` ปฏิบัติกับบีตกราฟิกเหมือนคลิปอื่นบน timeline ทุกประการ
